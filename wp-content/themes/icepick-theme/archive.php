  		...
  		<div class="col-lg-9">
    		...
    		<?php if (is_category()) { ?>
			    <h1 class="archive-title h2">
				    <span><?php _e("Posts Categorized:", "icepicktheme"); ?></span> <?php single_cat_title(); ?>
		    	</h1>
		    
		    <?php } elseif (is_tag()) { ?> 
			    <h1 class="archive-title h2">
				    <span><?php _e("Posts Tagged:", "icepicktheme"); ?></span> <?php single_tag_title(); ?>
			    </h1>
		    ...
		    ?>
			    <h1 class="archive-title h2">
			    	...
			    	<span><?php _e("Posts By:", "icepicktheme"); ?></span> <?php echo get_the_author_meta('display_name', $author_id); ?>

			    </h1>
		    <?php } elseif (is_day()) { ?>
			    <h1 class="archive-title h2">
						<span><?php _e("Daily Archives:", "icepicktheme"); ?></span> <?php the_time('l, F j, Y'); ?>
			    </h1>

  			<?php } elseif (is_month()) { ?>
    		    <h1 class="archive-title h2">
	    	    	<span><?php _e("Monthly Archives:", "icepicktheme"); ?></span> <?php the_time('F Y'); ?>
		        </h1>
		
		    <?php } elseif (is_year()) { ?>
		        <h1 class="archive-title h2">
		    	    <span><?php _e("Yearly Archives:", "icepicktheme"); ?></span> <?php the_time('Y'); ?>
		        </h1>
		    <?php } ?>
